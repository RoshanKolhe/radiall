...
import StorageLocationTableRow from '../storageLocation-table-row';
import StorageLocationTableToolbar from '../storageLocation-table-toolbar';
import StorageLocationTableFiltersResult from '../storageLocation-table-filters-result';
...
export default function StorageLocationListView() {
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.storageLocation.edit(id));
    },
    [router]
  );
  ...
  const handleViewRow = useCallback(
    (id) => {
      router.push(paths.dashboard.storageLocation.view(id));
    },
    [router]
  );
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Storage Location', href: paths.dashboard.storageLocation.root },
            { name: 'List' },
          ]}
          action={
            <Button
              component={RouterLink}
              href={paths.dashboard.storageLocation.new}
              variant="contained"
        ...
        <Card>
          ...
          {canReset && (
            <StorageLocationTableFiltersResult
              filters={filters}
              onFilters={handleFilters}
              //
