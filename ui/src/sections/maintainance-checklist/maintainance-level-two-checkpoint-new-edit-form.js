...
export default function CheckpointLevelTwoNewEditForm({ currentCheckpoint }) {
  ...
  const onSubmit = handleSubmit(async (formData) => {
    try {
      ...
      router.push(paths.dashboard.maintainanceChecklist.list(2));
    } catch (error) {
      console.error(error);
...
CheckpointLevelTwoNewEditForm.propTypes = {
