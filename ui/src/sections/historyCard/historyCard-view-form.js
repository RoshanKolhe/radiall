...
export default function HistoryCardViewForm({ currentHistoryCard }) {
        ...
        <Grid item xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <RHFTextField name="nature" label="Nature" disabled />
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <RHFTextField name="attendedBy" label="Attended By" disabled />
              </Grid>
            </Grid>
          </Card>
        </Grid>
