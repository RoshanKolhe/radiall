...
export default function ApprovalSection({ userData, formId, approvalStatus }) {
    ...
    const handleApproved = async () => {
        try{
            ...
            const response = await axiosInstance.post('/scrapping-form/user-approval', inputData);
    ...
    const handleCancel = async () => {
        try{
            ...
            const response = await axiosInstance.post('/scrapping-form/user-saved-form', inputData);
            if(response?.data?.success){
                enqueueSnackbar(response?.data?.message,{variant : 'success'});
                navigate(paths.dashboard.scrap.toolList);
            }else{
