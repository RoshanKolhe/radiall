...
const TABLE_HEAD = [
  ...
  { id: 'productionMeans', label: 'Tool Description'},
  { id: 'qty', label: 'QTY'},
  { id: 'meanSerialNo', label: 'Tool Serial Number', width: 100 },
  ...
  { id: 'criticalLevel', label: 'Critical Level'},
  ...
  { id: 'toolStatus', label: 'Tool Status', width: 100},
